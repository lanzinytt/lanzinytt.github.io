...
### [我的博客在这里 &rarr;](https://lanzinytt.github.io)
...
这个博客模板基于原 Hux Blog 模板进行了个人定制化修改。主要修改包括：
...
如需使用此模板，可以直接 fork 本仓库并根据需要进行修改。

```
$ git clone git@github.com:lanzinytt/lanzinytt.github.io.git
```

**[在这里预览博客 &rarr;](https://lanzinytt.github.io)**

## 各版本特性

##### New Feature (V1.5.2)

* 当你fork了这个仓库之后，模板已经进行了清理，可以直接开始使用。
...
* 你可以自由的fork。如果你能将主题作者信息保留在页面底部，我将非常感谢你。
* 如果你喜欢这个博客模板，请在`lanzinytt.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: LanZinYtt Blog             # 你的博客网站标题
SEOTitle: LanZinYtt Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: lanzinytt     # 你的github账号
weibo_username: lanzinytt      # 你的微博账号，底部链接会自动更新的。
